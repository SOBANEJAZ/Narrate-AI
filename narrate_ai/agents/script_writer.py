...
def write_script(client, topic: str, plan: NarrativePlan, retrieved_notes: list[dict]):
    ...
    prompt = f"""You are a documentary script writer. Write a 2-minute narrated documentary about {topic}.
...
5. Write in a spoken-language style, vivid but factual
6. Include smooth transitions between sections
7. No markdown headings - just flowing prose
